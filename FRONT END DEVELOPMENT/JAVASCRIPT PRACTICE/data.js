...
function myFunction(){
	...
	var result = citysAndSate.filter(filtered=>filtered.city.toLowerCase().includes(filter) + filtered.state.toLowerCase().includes(filter))
	var dis="";
	result.forEach(function(final){
		dis +="<tr>";
		dis+="<td>"+final.city+"</td>";
		dis+="<td>"+final.state+"</td></tr>";
	
		
	})
	document.querySelector("#tbody").innerHTML= dis;	
